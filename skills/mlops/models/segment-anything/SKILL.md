...
This imported skill does not bundle a local ONNX export helper. Use the upstream
Segment Anything export utility or your own checked-in export script, and record the
exact command alongside the resulting `.onnx` artifact.
