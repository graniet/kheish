...
# Raw XML
python3 -m zipfile -e presentation.pptx unpacked/
```
...
1. Analyze the template by converting it to PDF/JPEG previews
2. Unpack with `python3 -m zipfile -e` → manipulate slides → edit content → clean → pack
