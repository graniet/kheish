...
Usage in execute_code:
    exec(open(os.path.expanduser(
        "~/.kheish/skills/red-teaming/godmode/scripts/load_godmode.py"
    )).read())
...
_gm_scripts_dir = Path(os.getenv("KHEISH_HOME", Path.home() / ".kheish")) / "skills" / "red-teaming" / "godmode" / "scripts"
