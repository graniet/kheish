...
Use [OpenCode](https://opencode.ai) as an autonomous coding worker orchestrated by Kheish terminal/process tools. OpenCode is a provider-agnostic, open-source AI coding agent with a TUI and CLI.
...
Shell environments may resolve different OpenCode binaries. If behavior differs between your terminal and Kheish, check:
